...
namespace Ultima.Package
{
    ...
    public class UltimaStringCollection
    {
        ...
        /// </summary>
        public Dictionary<int, UltimaStringCollectionItem> Dictionary { get; set; }

        /// <summary>
        /// Gets or sets string collection as observable list.
        /// </summary>
        public ObservableCollection<UltimaStringCollectionItem> List { get; set; }
        #endregion
        ...
        {
            Dictionary = new Dictionary<int, UltimaStringCollectionItem>();
            List = new ObservableCollection<UltimaStringCollectionItem>();
        }
