...
namespace Ultima.Package
{
	...
	{
		#region Methods
		[DllImport("zlibwapi64", EntryPoint = "zlibVersion" )]
		...
		[DllImport("zlibwapi64", EntryPoint = "uncompress" )]
    ...
    {
        #region Methods
        [DllImport("zlibwapi32", EntryPoint = "zlibVersion")]
        private static extern string zlibVersion();
        ...
        [DllImport("zlibwapi32", EntryPoint = "uncompress")]
        private static extern ZLibError uncompress(byte[] dest, ref int destLen, byte[] source, int sourceLen);
